...
const BlogPost = ({ post, content, onBack }) => {
  ...
  return (
    <article
      className="bg-gradient-to-b from-[#0C1821] to-[#172A3A] px-4 md:px-0"
    ...
    >
      ...
      <div className="bg-[#0C1821] rounded-xl border border-white/10 shadow-lg overflow-hidden">
        ...
        <div className="prose prose-invert md:prose-lg max-w-3xl mx-auto px-6 md:px-10 pb-10">
          <ReactMarkdown
            ...
            components={{
              img: ({ node, ...props }) => (
                <img
                  {...props}
                  className="rounded-lg shadow-lg my-8 max-w-full mx-auto"
                />
              ),
              a: ({ node, ...props }) => (
                <a
                  {...props}
                  className="text-blue-400 hover:text-[#89FFAA] focus-visible:text-[#89FFAA] transition-colors outline-none focus-visible:ring-2 focus-visible:ring-[#89FFAA]"
                  target="_blank"
              ...
              code: ({ node, inline, className, children, ...props }) => (
                <code
                  className={`${className} ${inline ? "text-[#89FFAA]" : ""} focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#89FFAA]'`}
                  tabIndex={0}
                  {...props}
                >
                  {children}
